...
(function($) {
	$.fn.scrollbars = function() {
		return $(this).each(function() {
			...
			var $vscrollblock = $('<div class="scrollblock" style="height:40px"></div>');
			var $vscrollarea = $('<div class="scrollarea"></div>');
			
			// var $scrolltop = $('<div class="scrollbtn scrolltop"><img src="images/btUp.png"></div>');
			// var $scrolldown = $('<div class="scrollbtn scrolldown"><img src="images/btDown.png"></div>');			
